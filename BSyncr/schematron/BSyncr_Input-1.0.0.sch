...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" schemaVersion="1.0.0-2.1.0" queryBinding="xslt1">
  ...
  <sch:pattern see="" id="validate_bsyncr_pattern">
    ...
    <sch:rule context="/auc:BuildingSync/auc:Facilities/auc:Facility/auc:Sites/auc:Site/auc:Buildings/auc:Building">
      <sch:assert test="auc:Longitude" role="ERROR">auc:Longitude</sch:assert>
      <sch:assert test="auc:Latitude" role="ERROR">auc:Latitude</sch:assert>
    </sch:rule>
    ...
    <sch:rule context="/auc:BuildingSync/auc:Facilities/auc:Facility/auc:Reports/auc:Report/auc:Scenarios/auc:Scenario[auc:ScenarioType/auc:CurrentBuilding/auc:CalculationMethod/auc:Measured]">
      ...
      <sch:assert test="12 &lt;= count(auc:TimeSeriesData/auc:TimeSeries[auc:ResourceUseID/@IDref = $elec_resource_use_id])" role="ERROR">There must be greater than or equal to 12 TimeSeries linked to the Electricity ResourceUse</sch:assert>
    </sch:rule>
    <sch:rule context="/auc:BuildingSync/auc:Facilities/auc:Facility/auc:Reports/auc:Report/auc:Scenarios/auc:Scenario[auc:ScenarioType/auc:CurrentBuilding/auc:CalculationMethod/auc:Measured]/auc:TimeSeriesData/auc:TimeSeries">
      <sch:assert test="auc:StartTimestamp" role="ERROR">auc:StartTimestamp</sch:assert>
      <sch:assert test="auc:IntervalFrequency/text() = 'Month'" role="ERROR">auc:IntervalFrequency/text() = 'Month'</sch:assert>
      <sch:assert test="auc:IntervalReading" role="ERROR">auc:IntervalReading</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
